...
-- Add triggers for updated_at timestamps (skipped for minimal setup)
...
BEGIN
    ...
    SELECT id INTO v_template_id FROM schedule_templates WHERE name = 'Default Weekly Schedule';
