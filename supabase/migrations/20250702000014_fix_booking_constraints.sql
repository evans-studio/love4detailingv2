-- Drop existing unique constraint on time_slot_id
ALTER TABLE bookings DROP CONSTRAINT IF EXISTS unique_time_slot;

-- Add unique constraint on time_slot_id and user_id
ALTER TABLE bookings ADD CONSTRAINT unique_time_slot_user UNIQUE (time_slot_id, user_id);

-- Update the anonymous booking function to handle unique constraint
