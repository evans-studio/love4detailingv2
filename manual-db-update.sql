-- =========================================================================
-- Manual Database Update for Love4Detailing
-- Run this in Supabase SQL Editor to add the new columns
-- =========================================================================

-- 1. Add new columns to available_slots table
...
-- 4. Add RLS policies for reschedule_requests
...
-- 7. Create simple stored procedure for temporary reservations
...
SELECT 'Database update completed successfully! New columns and tables have been added.' as result;